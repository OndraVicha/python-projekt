...
x = 0
'''global = 1 3.Jako identifikátory nemohou být použita klíčová slova.'''
pomoc = 1
PI = 3.14
city = "Opava"
'''hilda@sspu-opava.cz = 'Hilda Dokonalá'  4. Součástí identifikátorů nemohou být symboly jako např. [!@#$%] a další.'''
email = 'hilda@sspu-opava.cz'
jmeno = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
''' 007agent = 'James Bond'  2. Identifikátory nemohou začínat numerickým znakem.'''
agent007 = 'James Bond'
